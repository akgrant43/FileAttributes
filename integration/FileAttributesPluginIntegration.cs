...
! !!FileSystemStore methodsFor: 'abstract' stamp: 'AlistairGrant 5/7/2017 12:46'!nodeAt: aPath ifPresent: presentBlock ifAbsent: absentBlock
	...
	! !!DiskStore methodsFor: 'accessing' stamp: 'AlistairGrant 4/26/2017 12:52'!defaultWorkingDirectory
	...
	(self isDirectory: path)
		...
		ifFalse: [ 
			StandardFileStream
				...
				forFileNamed: pathString ]! !!DiskStore class methodsFor: 'accessing' stamp: 'AlistairGrant 4/26/2017 12:50'!defaultWorkingDirectory
	...
	DiskFileAttributes initializeWithPrimitives: FileAttributePrimitives.! !!DiskStore class methodsFor: 'system startup' stamp: 'AlistairGrant 4/26/2017 12:50'!startUp: resuming
	self checkVMVersion.
	resuming 
		ifTrue: [ self reset ].
	DefaultWorkingDirectory := self defaultWorkingDirectory.! !!DiskStore class methodsFor: 'current' stamp: 'AlistairGrant 4/25/2017 23:08'!reset
